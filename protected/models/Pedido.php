...
class Pedido extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_producto, id_provedores, id_user, id_bodega, cantidad', 'required'),
			array('id_producto, id_provedores, id_user, id_bodega, cantidad', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, id_producto, id_provedores, id_user, id_bodega, cantidad', 'safe', 'on'=>'search'),
		);
	}
